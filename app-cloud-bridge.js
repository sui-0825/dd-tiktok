...
async function pullEntryRecords(reason='timer'){
 ...
 const cursor=state.entryCursor||(()=>{try{return localStorage.getItem(ENTRY_CURSOR_KEY)||new Date().toISOString()}catch(_){return new Date().toISOString()}})();
